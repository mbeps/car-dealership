...
/**
 * config/env.ts is a module-level singleton that parses process.env at import time,
...
describe("getSiteUrl", () => {
  beforeEach(() => {
    vi.unstubAllEnvs();
    // Remove vars entirely: empty strings fail the zod URL validation in config/env.ts
